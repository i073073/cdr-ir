...
- GitHub Pages URL: `https://i073073.github.io/cdr-ir/`
...
- GitHub 업로드: repo `i073073/cdr-ir` public 전환 후 Pages 활성화. 공개 URL `https://i073073.github.io/cdr-ir/` HTTP 200 및 Bento JSON 검증 완료.
